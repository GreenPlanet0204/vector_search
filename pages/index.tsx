...
export default function Home() {
  ...
  const [messageState, setMessageState] = useState<{
    ...
    messages: [
      {
        message: "Enter a prospect statement and I’ll return the filler that best matches it",
        type: 'apiMessage',
      },
    ],
    history: [],
                      ...
                      {message.sourceDocs && (
                        ...
                        >
                          <Accordion
                            ...
                            className="flex-col"
                          >
                            {message.sourceDocs.map((doc: any) => (
                              <div key={`messageSourceDocs-${index}`}>
                                <AccordionItem value={`item-${index}`}>
                                  ...
                                  <AccordionContent>
                                    <p className="mt-2">
                                      <b>Propsect:</b> {doc.content}
                                    </p>
                                    <p className="mt-2">
                                      <b>Filler:</b> {doc.filler}
                                    </p>
                                  </AccordionContent>
                                </AccordionItem>
                              </div>
                  ...
                  <textarea
                    ...
                    placeholder={
                      loading
                        ...
                        : 'Type the last thing the prospect said here...'
                    }
                    value={query}
